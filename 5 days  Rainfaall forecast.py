...
api_key = '37746f16507a86de96c3343089d7e831'
api_call = 'https://api.openweathermap.org/data/2.5/forecast?appid=' + api_key

running = True

print('Welcome to Cropit\'s 5 day weather forecast by OpenWeatherMap\'s API!')
...
while running:
    ...
    while True:
        ...
        if running.lower() == 'yes' or running.lower() == 'y':
            ...
            print('Thank you for using Cropit\'s 5 day weather forecast application.')
            running = False
            break
        else:
